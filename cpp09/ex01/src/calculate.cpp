...
static bool	additionCheck( int n1, int n2 );
static bool	subtractionCheck( int n1, int n2 );
static bool	multiplicationCheck( int n1, int n2 );
static bool	divisionCheck( int n1, int n2 );
